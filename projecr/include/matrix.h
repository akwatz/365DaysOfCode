...
int				computeRank(int M, int Q, int **matrix);
...
int**	create_matrix(int M, int Q);
void			display_matrix(int M, int Q, int **m);
void			def_matrix(int M, int Q, int **m,int k);
void			delete_matrix(int M, int **matrix);