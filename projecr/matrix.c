...
int
computeRank(int M, int Q, int **matrix)
{
...
void
perform_elementary_row_operations(int flag, int i, int M, int Q, int **A)
{
	int		j, k;
...
int
find_unit_element_and_swap(int flag, int i, int M, int Q, int **A)
{ 
	int		index, row_op=0;
...
int
swap_rows(int i, int index, int Q, int **A)
{
	int			p;
	int	temp;
...
int
determine_rank(int m, int M, int Q, int **A)
{
...
void
def_matrix(int M, int Q, int **m,int k)
{
	int		i,j;
...
void
delete_matrix(int M, int **matrix)
{
	int		i;
